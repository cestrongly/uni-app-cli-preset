export default [{
    ...
    groupName_en: '基础功能',
    list: [{
        path: '/pages/test/process-env/process-env',
        icon: 'color',
        title: '环境变量测试',
        title_en: '环境变量测试'
    }, {
        path: '/pages/test/upload/upload',
        icon: 'icon',
        title: 'upload 上传图片测试',
        title_en: 'Icon'
    }, {
        path: '/pages/test/added-button/added-button',
        icon: 'image',
        title: 'cedo-addedButton 测试',
        title_en: 'Image'
    }, {
        path: '/pages/test/change-theme/change-theme',
        icon: 'button',
        title: '切换主题测试',
        title_en: 'Button'
    }, {
