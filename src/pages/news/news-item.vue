<template>
  ...
  >
    ...
    >
      <text
        class="media-title"
        :class="{'media-title2': newsItem.article_type === 1 || newsItem.article_type === 2}"
      >
        {{ newsItem.title }}
      </text>
      <view
        v-if="newsItem.image_list || newsItem.image_url"
        class="image-section flex-row"
      ...
      >
        ...
        <template v-if="newsItem.image_list">
          <image
            ...
            class="image-list3"
            :src="source.url"
            v-for="(source, i) in newsItem.image_list"
            :key="i"
          />
        </template>
      </view>
    ...
    <view class="media-foot flex-row">
      ...
      <view
        ...
        @click.stop="close"
      >
        <view class="close-l close-h" />
        <view class="close-l close-v" />
      </view>
    </view>
    <view
