<template>
  <view class="content">
    ...
    <view class="article-meta">
      ...
      <text class="article-meta-text article-text">
        发表于
      </text>
